...
from libspot import Version
from libspot.audio import AudioKeyManager
from libspot.audio import CdnManager
from libspot.audio import PlayableContentFeeder
from libspot.audio.storage import ChannelManager
from libspot.cache import CacheManager
from libspot.crypto import CipherPair
from libspot.crypto import DiffieHellman
from libspot.crypto import Packet
from libspot.mercury import MercuryClient
from libspot.mercury import MercuryRequests
from libspot.mercury import RawMercuryRequest
from libspot.metadata import AlbumId
from libspot.metadata import ArtistId
from libspot.metadata import EpisodeId
from libspot.metadata import PlaylistId
from libspot.metadata import ShowId
from libspot.metadata import TrackId
from libspot.oauth import OAuth
from libspot.proto import Authentication_pb2 as Authentication
from libspot.proto import ClientToken_pb2 as ClientToken
from libspot.proto import Connect_pb2 as Connect
from libspot.proto import Connectivity_pb2 as Connectivity
from libspot.proto import Keyexchange_pb2 as Keyexchange
from libspot.proto import Metadata_pb2 as Metadata
from libspot.proto import Playlist4External_pb2 as Playlist4External
from libspot.proto.ExtendedMetadata_pb2 import EntityRequest, BatchedEntityRequest, ExtensionQuery, BatchedExtensionResponse
from libspot.proto.ExtensionKind_pb2 import ExtensionKind
from libspot.proto.ExplicitContentPubsub_pb2 import UserAttributesUpdate
from libspot.proto.spotify.login5.v3 import Login5_pb2 as Login5
from libspot.proto.spotify.login5.v3.credentials import Credentials_pb2 as Login5Credentials
from libspot.structure import Closeable
from libspot.structure import MessageListener
from libspot.structure import RequestListener
from libspot.structure import SubListener
        ...
        def stored_file(self,
            ...
            if os.path.isfile(stored_credentials):
                try:
                    ...
                    try:
                        # Try Python libspot format first
                        self.login_credentials = Authentication.LoginCredentials(
                            typ=Authentication.AuthenticationType.Value(
                                obj["type"]),
                            username=obj["username"],
                        ...
                        # Try Rust libspot format (auth_type as int, auth_data instead of credentials)
                        try:
                            self.login_credentials = Authentication.LoginCredentials(
                                typ=obj["auth_type"],
                                username=obj["username"],
